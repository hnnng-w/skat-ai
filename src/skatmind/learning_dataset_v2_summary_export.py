...
LEARNING_DATASET_SUMMARY_DOCUMENT_KIND = "skatmind_learning_dataset_v2_cross_game_summary"

_SUMMARY_EXPORT_ID_DOMAIN = b"skatmind\0learning_dataset_v2_summary_export_v1\0"
