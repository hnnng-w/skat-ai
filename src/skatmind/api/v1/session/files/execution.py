...
from skatmind.api.v1.session.files.schema_validation import (
    validate_session_file_result_document,
)
from skatmind.errors import SkatMindError, SkatMindSerializationError, SkatMindValidationError
from skatmind.session_persistence import (
    load_session_persistence_file_v1,
    save_session_persistence_file_v1,
)
from skatmind.session_persistence_contracts import SessionPersistenceDocumentV1
...
def serialize_session_file_result(
    ...
    if type(result) is not SessionFileApiResultV1:
        raise SkatMindSerializationError(
