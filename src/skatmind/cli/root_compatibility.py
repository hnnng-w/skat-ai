...
from skatmind.application.simple_workflows import SimpleWorkflowDependencies
...
from skatmind.input_loader import get_input_workflow, load_opponent_statistics_from_json
...
CliUsageError = SkatMindCliUsageError
...
def legacy_patch_namespace(namespace: ModuleType):
    ...
    facade = sys.modules.get("skatmind.cli.execution")
    previous_facade = (
