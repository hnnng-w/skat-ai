...
from skatmind import errors as skat_errors
from skatmind.application import contracts as application_contracts
...
from skatmind.cli.session_context import SessionContext as _SessionContext
...
SkatMindInvariantError = skat_errors.SkatMindInvariantError
SkatMindValidationError = skat_errors.SkatMindValidationError
...
def run_session_cli(
    ...
    *,
    ...
    except SkatMindCliUsageError as error:
