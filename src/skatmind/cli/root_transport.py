...
from skatmind.bounded_search_evaluation import (
    DEFAULT_BOUNDED_SEARCH_EVALUATION_PARTITIONS,
)
from skatmind.cli.presentation.dataset import (
...
from skatmind.cli.presentation.opponent_statistics import (
    print_historical_opponent_statistics_result,
    print_opponent_statistics_result,
)
from skatmind.cli.presentation.position import print_analysis_result
from skatmind.cli.presentation.provenance import print_field_provenance_summary
from skatmind.cli.presentation.simulation import (
    print_multi_step_result,
    print_policy_comparison_result,
)
from skatmind.cli.root_application import (
    execute_legacy_application,
    load_external_opponent_statistics_document,
)
from skatmind.cli.root_compatibility import CliUsageError, _facade_value
from skatmind.cli.root_option_context import (
    current_supplied_root_cli_options,
    invoke_with_supplied_workflow_option_names,
)
from skatmind.cli.root_validation import validate_live_opponent_profile_options
...
from skatmind.input_loader import load_json_object, load_position_from_json
...
def run_json_dataset_partition_audit(
    ...
    except (SkatMindWorkflowError, ValueError) as error:
        if not isinstance(error, SkatMindWorkflowError) and (
