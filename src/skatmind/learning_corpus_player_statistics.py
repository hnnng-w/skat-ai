...
_STATISTICS_RECORD_FINGERPRINT_DOMAIN = b"skatmind\0learning_corpus_player_statistics_record_v1\0"
_STATISTICS_OBSERVATION_ID_DOMAIN = b"skatmind\0learning_corpus_player_statistics_observation_v1\0"
