...
SETTLEMENT_NORMATIVE_MATRIX = (
    ...
    *(
    ...
    _case(
        ...
        implementation_modules=("skatmind.game_result", "skatmind.final_settlement"),
    ),
    _case(
    ...
    _case(
        ...
        overbid_policy=NORMAL_SUPPORTED_OVERBID,
        settlement_policy=NORMAL_SETTLEMENT,
        implementation_modules=("skatmind.game_declaration", "skatmind.final_settlement"),
    ),
    _case(
    ...
    _case(
        ...
        implementation_modules=(
            "skatmind.game_end",
            "skatmind.impossible_null_settlement",
            "skatmind.final_settlement",
        ),
        notes=(
    ...
    _case(
        ...
        overbid_policy=NORMAL_SUPPORTED_OVERBID,
        settlement_policy=DOUBLED_DECLARER_LOSS,
        implementation_modules=("skatmind.overbid", "skatmind.final_settlement"),
    ),
    _case(
        ...
        implementation_modules=("skatmind.input_validation",),
    ),
    _case(
        ...
        implementation_modules=("skatmind.final_settlement",),
    ),
    _case(
        ...
        implementation_modules=(
            ...
            "skatmind.historical_declarer_card_exposure_continuation",
        ),
    ...
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_event",
            "skatmind.historical_defender_open_play_continuation",
        ),
        notes=("The later normal completion is settled independently from this event.",),
    ),
    _case(
    ...
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_end",
            "skatmind.historical_declarer_card_exposure",
        ),
    ),
    _case(
    ...
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_end",
            "skatmind.historical_declarer_concession",
        ),
    ),
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_end",
            "skatmind.historical_defender_concession",
        ),
    ),
    _case(
    ...
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_end",
            "skatmind.historical_defender_open_play",
    ...
    _case(
        ...
        overbid_policy=NORMAL_SUPPORTED_OVERBID,
        settlement_policy=NORMAL_SETTLEMENT,
        implementation_modules=("skatmind.historical_game", "skatmind.final_settlement"),
    ),
    _case(
        ...
        implementation_modules=(
            "skatmind.historical_game_end",
            "skatmind.historical_open_card_throw",
            "skatmind.theoretical_level_exclusion",
        ),
    ),
    _case(
    ...
    _case(
        ...
        overbid_policy=NORMAL_SUPPORTED_OVERBID,
        settlement_policy=NORMAL_SETTLEMENT,
        implementation_modules=("skatmind.game_end", "skatmind.final_settlement"),
    ...
    _case(
        ...
        settlement_policy=NO_TERMINAL_SETTLEMENT,
        terminal_effect=NON_TERMINAL,
        implementation_modules=("skatmind.game_end",),
    ),
    _case(
        ...
        overbid_policy=PRESERVE_REQUIRED_VALUE,
        settlement_policy=EXISTING_SHORTENING_SETTLEMENT,
        implementation_modules=("skatmind.declarer_card_exposure", "skatmind.final_settlement"),
    ),
    _case(
    ...
    _case(
        ...
        settlement_policy=NO_TERMINAL_SETTLEMENT,
        terminal_effect=NON_TERMINAL,
        implementation_modules=("skatmind.declarer_card_exposure_continuation",),
    ),
    _case(
        ...
        overbid_policy=PRESERVE_REQUIRED_VALUE,
        settlement_policy=DOUBLED_DECLARER_LOSS,
        implementation_modules=("skatmind.declarer_concession", "skatmind.final_settlement"),
    ),
    _case(
        ...
        overbid_policy=PRESERVE_REQUIRED_VALUE,
        settlement_policy=EXISTING_SHORTENING_SETTLEMENT,
        implementation_modules=("skatmind.defender_concession", "skatmind.final_settlement"),
    ),
    _case(
    ...
    _case(
        ...
        settlement_policy=EXISTING_SHORTENING_SETTLEMENT,
        proof_policy=DEFENDER_OPEN_PLAY_V1,
        implementation_modules=("skatmind.defender_open_play", "skatmind.exact_rest_trick_proof"),
        proof_quantifiers=DEFENDER_OPEN_PLAY_V1_QUANTIFIERS,
        proof_maximum_unresolved_tricks=5,
    ),
    _case(
    ...
    _case(
        ...
        settlement_policy=NO_TERMINAL_SETTLEMENT,
        terminal_effect=NON_TERMINAL,
        implementation_modules=("skatmind.defender_open_play_continuation",),
    ),
    _case(
        ...
        settlement_policy=EXISTING_SHORTENING_SETTLEMENT,
        proof_policy=OPEN_THROW_JACK_EXCLUSION_V1,
        implementation_modules=("skatmind.open_card_throw", "skatmind.theoretical_level_exclusion"),
    ),
    _case(
