...
def build_browser_safe_application_state_v1() -> BrowserSafeApplicationStateV1:
    ...
    tasks = (
        ...
        HomeTaskV1(
            ...
            expected_result="A resumable Session lifecycle will be added in a later update.",
            available=False,
            availability="Managed Session workflow not yet available.",
        ),
        HomeTaskV1(
            route="/matches",
            ...
            mode="Retrospective",
            expected_result="A managed Match capture lifecycle will be added in a later update.",
            available=False,
            availability="Managed Match workflow not yet available.",
        ),
        HomeTaskV1(
            route="/learning",
            ...
            mode="Retrospective",
            expected_result="A managed Learning lifecycle will be added in a later update.",
            available=False,
            availability="Managed Learning workflow not yet available.",
        ),
        HomeTaskV1(
            route="/about",
