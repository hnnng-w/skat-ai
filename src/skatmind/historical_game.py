...
from skatmind.historical_declarer_card_exposure import (
    adjudicate_historical_declarer_card_exposure,
)
from skatmind.historical_declarer_concession import (
    adjudicate_historical_declarer_concession,
)
from skatmind.historical_defender_concession import (
    adjudicate_historical_defender_concession,
)
from skatmind.historical_defender_open_play import (
...
from skatmind.historical_game_event import (
    HistoricalGameEvent,
...
from skatmind.historical_open_card_throw import adjudicate_historical_open_card_throw
...
def build_historical_game_summary(record: HistoricalGameRecord) -> dict[str, Any]:
    ...
    if record.game_end_reason in {
        ...
        if record.game_end_reason == HISTORICAL_DECLARER_CONCESSION:
            ...
            from skatmind.historical_party_wide_claim import (
