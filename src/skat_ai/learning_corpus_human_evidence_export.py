...
LEARNING_CORPUS_HUMAN_EVIDENCE_DOCUMENT_KIND = "skat_ai_learning_corpus_human_evidence"
LEARNING_CORPUS_HUMAN_EVIDENCE_EXPORT_POLICY = "deterministic_path_free_json_document"

_HUMAN_EVIDENCE_EXPORT_ID_DOMAIN = b"skat-ai\0learning_corpus_human_evidence_export_v1\0"
