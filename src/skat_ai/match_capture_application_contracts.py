...
from skat_ai.match_workspace_operations import MatchWorkspaceChangeResultV1
from skat_ai.match_workspace_progress import MatchWorkspaceProgressV1
from skat_ai.observed_game_evidence import ObservedGameEvidenceSummaryV1
...
class MatchCaptureApplicationResultV1:
    ...
    def _validate_relationships(self, *, validate_exact_position_view: bool) -> None:
        ...
        if validate_exact_position_view:
            from skat_ai.match_capture_position_view import (
