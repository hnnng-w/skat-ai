...
_PLATFORM_ALIAS_OBSERVATION_ID_DOMAIN = b"skat-ai\0learning_corpus_platform_alias_observation_v1\0"
_PLATFORM_ALIAS_CONFLICT_ID_DOMAIN = b"skat-ai\0learning_corpus_platform_alias_conflict_v1\0"
