...
def determine_decision_state_before_concession(
    game_result_summary: dict[str, Any],
    game_value_summary: dict[str, Any],
    overbid_summary: dict[str, Any],
    completed_tricks: list[dict[str, Any]],
) -> str:
    """Determines whether the declared contract was decided before concession."""
...
def adjudicate_defender_concession(
    ...
    decision_state = determine_decision_state_before_concession(
        game_result_summary,
        game_value_summary,
        overbid_summary,
        completed_tricks,
