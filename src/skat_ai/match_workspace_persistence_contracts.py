...
from skat_ai.match_workspace_contracts import MatchWorkspaceV1, validate_match_workspace_v1
from skat_ai.match_workspace_progress import MatchWorkspaceProgressV1

MATCH_WORKSPACE_PERSISTENCE_VERSION = 1
MATCH_WORKSPACE_DOCUMENT_KIND = "skat_ai_match_workspace"
...
class MatchWorkspacePersistenceDocumentV1:
    ...
    def _validate_structure(self, *, validate_workspace: bool) -> None:
        ...
        if self.document_kind != MATCH_WORKSPACE_DOCUMENT_KIND:
            raise ValueError(
