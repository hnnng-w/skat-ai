...
from skat_ai.observed_game_trace import ObservedGameTraceSummaryV1
...
def _materialize_historical_list_from_slots_v1(
    ...
    *,
    ...
    if len(entry_facts_output) != 1:
        raise SkatAIInvariantError("List materialization must derive Entry Facts exactly once.")
    try:
