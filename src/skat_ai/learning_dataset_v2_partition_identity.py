...
from skat_ai.learning_dataset_v2_contracts import LearningDatasetV2
...
LEARNING_DATASET_PARTITION_SOURCE_IDENTITY_DOMAIN = (
    b"skat-ai\0learning_dataset_v2_partition_source_identity_v1\0"
)
LEARNING_DATASET_PARTITION_SOURCE_CONTENT_DOMAIN = (
    b"skat-ai\0learning_dataset_v2_partition_source_content_v1\0"
)
LEARNING_DATASET_PARTITION_REQUEST_DOMAIN = b"skat-ai\0learning_dataset_v2_partition_request_v1\0"
LEARNING_DATASET_MATCH_GROUP_ID_DOMAIN = b"skat-ai\0learning_dataset_v2_match_group_v1\0"
LEARNING_DATASET_PLAYER_COMPONENT_ID_DOMAIN = b"skat-ai\0learning_dataset_v2_player_component_v1\0"
LEARNING_DATASET_PARTITION_PLAN_FINGERPRINT_DOMAIN = (
    b"skat-ai\0learning_dataset_v2_partition_plan_v1\0"
)
LEARNING_DATASET_PARTITION_AUDIT_FINGERPRINT_DOMAIN = (
    b"skat-ai\0learning_dataset_v2_partition_audit_v1\0"
)
LEARNING_DATASET_PARTITIONED_VIEW_FINGERPRINT_DOMAIN = (
    b"skat-ai\0learning_dataset_v2_partitioned_view_v1\0"
)
LEARNING_DATASET_PARTITION_EXPORT_ID_DOMAIN = b"skat-ai\0learning_dataset_v2_partition_export_v1\0"
