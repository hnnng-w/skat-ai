...
def _build_position_fact(
    ...
    from skat_ai.match_workspace_contracts import MatchWorkspacePositionFactV1
    from skat_ai.observed_game_evidence import build_observed_game_evidence_summary_v1
...
def build_match_workspace_position_facts_v1(
    ...
    from skat_ai.match_workspace_contracts import validate_match_workspace_v1
