...
from skat_ai.cli.session_application import LegacyApplicationExecutor
from skat_ai.cli.session_checkpoints import CheckpointCollector
from skat_ai.cli.session_context import SessionContext
from skat_ai.cli.session_transport import load_strict_json_object
...
def run_assistant(
    ...
    *,
    ...
    from skat_ai.cli.session_assistant import (
