...
from skat_ai.historical_game_end import build_serializable_historical_game_end
from skat_ai.historical_game_event import build_serializable_historical_game_event
