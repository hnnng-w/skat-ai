...
LEARNING_CORPUS_CATALOG_DOCUMENT_KIND = "skat_ai_learning_corpus_catalog"
...
class LearningCorpusCatalogPersistenceDocumentV1:
    ...
    def _validate_structure(self, *, validate_catalog: bool) -> None:
        ...
        if self.document_kind != LEARNING_CORPUS_CATALOG_DOCUMENT_KIND:
            raise ValueError(
                "document_kind must equal "
                f"{LEARNING_CORPUS_CATALOG_DOCUMENT_KIND!r}."
            )
