...
* Historical records support normal completion and exact-prefix declarer and defender concessions; claims, exposure/open-play/throwing, continuation, and other end reasons are not represented there.
...
coverage now includes 44 deterministic scenarios. Issues #86 through #92 add
