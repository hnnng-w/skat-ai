...
* Historical records support normal completion, exact-prefix declarer and defender concessions, unanimously accepted declarer-card exposure, and bounded terminal defender open play; other claims, historical continuations, open-card throwing, and other end reasons are not represented there.
...
coverage now includes 46 deterministic scenarios. Issues #86 through #92 add
