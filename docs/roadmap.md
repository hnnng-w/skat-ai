...
* Historical records support normal completion, exact-prefix declarer and defender concessions, and unanimously accepted declarer-card exposure; other claims, historical exposure continuation, open play/throwing, and other end reasons are not represented there.
...
coverage now includes 45 deterministic scenarios. Issues #86 through #92 add
