...
state. A decision's hidden-card model uses only its visible prefix, current
trick, public hands, and legitimate skat knowledge; the actual next card, future
cards, result, and settlement are excluded. See
