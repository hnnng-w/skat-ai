...
[Historical open card throw](historical_open_card_throw.md). Historical
...
A single supported continuation may precede this concession. Multiple
continuations, arbitrary event streams, claims of remaining tricks, and
historical end kinds beyond the supported union remain unsupported.
