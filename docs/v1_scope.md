...
Profile derivation without policy application. `v1.0.0` remains unready, and
its final planning still requires a separate audit of this document and
[Requirements traceability](requirements_traceability.md).
...
* Support usable manual post-game Match capture for one EuroSkat 36er Standard
  ...
  derivation, and browser Add/Replace/Clear without applying a policy.
  Materialization, Public Match API, Match Schema/data workflow, actual Profile
  application, and analysis remain open.
