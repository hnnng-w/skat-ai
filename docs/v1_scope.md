...
downloads. Package version remains `0.15.0`; `v0.16.0` Release preparation and
publication remain open. No Public API, Schema, Root workflow, derived-artifact
...
| Regression testing | Ruff, 63-Schema packaged parity, Root and Session example validation, 85-scenario generated-output validation, distribution build and clean-install API/installed/module Root, Session, Capture, and Corpus CLI validation remain the current gates. The published `v0.15.0` Package baseline passed 6,510 pytest tests; Issue #179's later tests do not rewrite that published count. The published `v0.14.0` baseline remains historical evidence for 5,892 tests. |
