...
* Support retrospective single-decision review and complete-game coaching
  ...
  retrospective observed-card attachment and defines impact semantics, but key
  decisions, turning points, patterns, recommendations, and a complete coaching
  workflow do not.
...
public report. See [Replay coaching contracts](replay_coaching_contracts.md).
