...
| Stable installed interface | API contract version `1` exposes seven Root workflows and stable errors/results; installed, module, and Legacy forms preserve Root parity and share the additive Session parser, 12 subcommands, private Capture and Corpus command families, explicit paths, privacy-safe output, CAS persistence, and Exit Codes through one Console Script. Issue #189 adds Root modes and flags, and Issue #192 adds the Historical Information-set Coaching flag, without adding a workflow or Console Script. Wheel/sdist clean installs verify 70 packaged Schemas, public Session files, Historical Claim and Information-set Coaching execution, Session workflows, exact Capture/Corpus resources and help, and both local browser smoke flows. No Package-index publication is implied. |
...
| Generated-output validation | The current unreleased matrix has 96 scenarios: the published `v0.16.0` and historical published `v0.15.0` and `v0.14.0` 85 remain unchanged, followed by three Issue #186 Historical Claim scenarios, four Issue #189 Information-set Search scenarios, two Issue #190 Multi-Step/Policy Comparison scenarios, and two Issue #192 Information-set Replay Coaching scenarios. The historical published `v0.13.0` first 77 and historical published `v0.12.0` 70 remain Release evidence. |
