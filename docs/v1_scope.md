...
Live Position Request export, Decision checkpoints, Undo/correction, persistence,
Public API, Provenance propagation, Schemas, CLI, examples/generated output, and
...
* Support interactive live and retrospective input and Session capture. Issue
  ...
  execution. Live Position Request export, Decision checkpoints, end-to-end
  capture, Undo/correction, persistence, Public API, Provenance, Schemas, CLI,
  examples/generated output, and UI remain open.
