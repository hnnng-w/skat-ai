...
writes, canonical files, and atomic same-directory replacement. Session-
triggered analysis, actual-card Checkpoint attachment, Public API, Provenance,
Schemas, CLI, examples/generated output, automatic Checkpoint collection, end-
to-end capture, and UI remain open. Online-platform adapters, browser extensions,
...
limitations are implemented by Issue #155; public and end-to-end Session capture
remain open. See
