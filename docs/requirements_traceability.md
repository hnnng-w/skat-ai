...
and strict Schema. The active repository has 62 schemas and 77 generated-output
scenarios. The seven provenance scenarios are append-only, so the published
`v0.12.0` facts remain 70 scenarios and 4,762 tests. The `v0.13.0` functional
