...
construction plus existing aggregation without workflow execution. Browser
execution/export, Public Match API, Match Schema/data workflow, actual Profile
application, and analysis remain absent. `v1.0.0` remains unready after this
focused milestone work.
...
| Requirement | Source | Rule section | Current status | Current implementation | Required input or information | Known limitation | Required validation or tests | Target milestone | Required before v1.0 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Match Capture identity and metadata | skat-ai product | Not applicable | `partially_supported` | Issue #160 defines internal immutable version-1 Match Capture, Source Metadata, Media Timecode, Tournament Format, Participant, and Player Statistics Snapshot values. Issue #163 retains the definition inside one exact Workspace, Issue #164 consumes it through internal Capture Application services, Issue #165 creates or corrects metadata through private browser forms, Issue #166 edits one Match-bound Snapshot per participant, and Issue #167 consumes the unchanged Match definition for internal preparation. | Caller-supplied Match identity/title/platform, optional external ID and played time, one canonical format, one descriptive source, exactly three participants, one perspective Player, and optional Match-bound statistics snapshots. | Public Match API, Match Schema/data workflow, global Player history, actual Profile application, workflow execution, browser/public export, YouTube integration, and EuroSkat integration remain absent. Ranking, qualification, prize, fee, and bonus rules are not implemented. | Retain source relationships and no-network behavior, exact registry identity/order, deterministic snapshot IDs, identity/time reconciliation, strict eligibility, fixed-place and perspective relationships, browser creation/correction/editing, uniqueness, unchanged public exports, and unchanged Package/Schema/scenario counts. | v0.15.0 usable local capture complete; execution/public use open | Yes |
| Observed Game evidence and commentary | skat-ai product | Not applicable | `partially_supported` | Issue #161 defines internal immutable observed Game, Play, evidence-summary, free-text Decision commentary, and linked later-response values. Issue #163 places them in exact rotated Slots; Issue #164 updates only rebuilt complete candidates; Issue #165 exposes setup, Play, Commentary, Response Link, truncation, Passed Deal, and clear browser operations; Issue #167 prepares acting-own-hand Decisions and strict Historical materialization without changing retained evidence. | One exact Match definition, selected position, optional observed Card evidence, optional Declarer/Declaration, zero through 30 public Plays, and optional annotations. | Public Match API/Schema/data workflow, workflow execution, browser/public export, and tactical interpretation remain absent. Missing Skat and Discards remain unknown and can block strict Historical materialization while Decisions remain preparable. | Retain null-versus-empty semantics, information safety, complete replay, evidence relationships, automatic actor/index derivation, multiline Commentary on all Players, later-only links, truncation cleanup, no inferred taxonomy, and unchanged public/count boundaries. | v0.15.0 usable local observation and internal preparation complete; execution open | Yes |
| Persistent EuroSkat Match Workspace | skat-ai product | Not applicable | `partially_supported` | Issue #163 defines exact 36-Slot Workspaces, rotation, revisions, Progress, fingerprints, strict Resume, and optimistic atomic Save. Issue #165 adds one locked explicit-file context, absent creation, strict startup Resume, exact-revision operation plus content-fingerprint CAS autosave, unchanged/conflict no-write behavior, and explicit Reload. Issue #166 reuses definition replacement for Snapshot updates. Issue #167 derives non-persisted materialization summaries from an already loaded Workspace. | One exact Match definition, optional observed Games/passed deals/Snapshots, exact revisions, one explicit existing-parent file path, and retained fingerprint. | Structural completion does not imply Historical materializability. Derived materialization is not persisted or browser-exposed. No Profile application, Public Match API/Schema, distributed lock, retry/merge, remote deployment, cloud, encryption, or backup exists. | Retain all Workspace/persistence bytes and rules plus one operation/at-most-one Save, all-Slot preservation, no context replacement on conflict, explicit-only Reload, private path/fingerprint omission, and unchanged public/count boundaries. | v0.15.0 usable local persistence complete; execution/public use open | Yes |
| Rapid post-game Match Capture Application services | skat-ai product | Not applicable | `partially_supported` | Issue #164 defines transport-free Card entries, Views, Results, setup, automatic Play append, truncation/annotation cleanup, annotation editing, and pass/clear wrappers. Issue #165 maps browser operations directly to these services and preserves exact versus bounded Card wording. Issues #166 and #167 remain separate Statistics and materialization-preparation layers. | One loaded Workspace, selected position, exact revision, and operation-specific observed evidence. | Services themselves still perform no I/O or downstream preparation. Public Match API/Schema/data workflow, Profile application, materialization controls, analysis, tactical interpretation, and AI commentary remain absent. Bounded candidates do not assert ownership or legality. | Retain all Issue #164 identities/behavior, direct delegation, conflict precedence, atomic batches, automatic actors/indexes, no hidden completion, import direction, and unchanged persistence/public/count boundaries. | v0.15.0 usable local transport complete; broader product open | Yes |
| Match review and materialization preparation | skat-ai product | Not applicable | `supported` | Issue #167 defines internal Decision Review Preparation, Historical Game Materialization, Training Source Collection, and Workspace Materialization version `1`. It reconstructs only the acting own hand, attaches the actual Card after the visible-state cutoff, excludes future-opponent ownership, preserves Skat/Ouvert semantics, prepares time-safe relative Profile bindings without application, materializes only strict complete-Deal normal completion with Match-level `played_at`, creates existing unpartitioned Training source Records, and builds a complete existing 36-position list plus aggregation with Passed Deals and optional external lot. Commentary remains a counted Workspace sidecar. | One validated Workspace; exact acting playable-hand evidence per Decision; complete legal trace, original Skat, and exact Discards for Historical/Training played positions; all 36 Slots classified and every played position strict-Historical-materializable for the list; optional exact lot order. | Internal preparation only. No workflow execution, browser action, persistence result, public export/API/Schema, Dataset Plan/partition/sample, Profile/Policy application, report, comparison, or media-offset timestamp derivation exists. | Retain Decision/Historical evidence separation, own-hand-only reconstruction, actual-Card cutoff, Skat/Ouvert visibility, profile temporal/relative safety, canonical Historical round trip, Match-time policy, unpartitioned identities, exact Slot statuses/counts, Passed Deals, Commentary isolation, list/aggregation/external-lot reuse, no-execution/public boundaries, and unchanged 0.14.0/63/85 baselines. | v0.15.0 bounded internal preparation complete | Yes |
| Local Match Capture browser and CLI transport | skat-ai product | Not applicable | `supported` | Issue #165 adds internal Match Capture Web, Protocol, and CLI version `1`; Issue #166 preserves its first 17 operations and appends Snapshot set/clear for an exact 19-operation order; leading `capture` dispatch; required one-file CLI; loopback Standard Library HTTP server; token/cookie/same-origin/Host/request-limit/security-header controls; deterministic path-free state and server HTML; packaged local assets; no-JavaScript forms plus keyboard/focus enhancement; and Wheel/sdist clean-install smoke. | One explicit Workspace path with existing parent, browser startup token/cookie, exact local origin, selected position, exact revision, and operation form or JSON body. | Private local transport only. Issue #167 is not browser-exposed. No remote bind, account, access-control or encryption claim, external request, Public Match API/Schema/Root workflow, analysis, materialization/export control, global history, Profile application, YouTube/EuroSkat integration, database, cloud, or backup. | Retain exact versions/policies/routes/options, 36 positions, creation/Resume/setup/Card/correction/annotation/pass/clear/Statistics flows, temporal warnings, Profile presentation, autosave counts/conflicts/Reload, security/privacy, packaged resources, one Console Script, clean installs, and unchanged 0.14.0/63/85/public boundaries. | v0.15.0 bounded local interface complete | Yes |
...
| Generated-output validation | skat-ai product | Not applicable | `supported` | The active matrix generates, semantically checks, and schema-validates 85 deterministic scenarios. Issue #157 appends eight Session scenarios after the published `v0.13.0` 77; historical published `v0.12.0`, `v0.11.0`, and `v0.10.0` counts remain 70, 64, and 59. | Repository examples/fixtures, 63 schemas, and deterministic Root/Session CLI settings. | The matrix is representative rather than exhaustive; append-only additions do not rewrite historical published Release evidence. | Keep active and published counts explicit; retain prior byte identity and add deterministic coverage for each stable user-facing branch. | v1.0 | Yes |
| Release and regression checks | skat-ai product | Not applicable | `supported` | `scripts/check.ps1` and CI run Ruff, 63-Schema parity, Root/Session examples, 85 scenarios, Wheel/sdist inspection, clean API/Root/Session/Capture CLI and browser persistence smoke, and pytest on Python 3.13. | Development dependencies and supported platform tooling. | Passing checks proves tested behavior, not complete ISkO/SkWO compliance; no publication is claimed. | Require clean local/CI checks, exact Capture resources and one Console Script, installed/module/Legacy/API parity, and human-controlled publication. | v1.0 | Yes |
