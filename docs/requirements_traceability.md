...
through Settlement Normative Matrix version `2`, preserving all 61 case IDs.
...
creates no outcome. Runtime/Historical/Public integration remains absent.
All other current Claim boundaries remain `not_supported_v1`. Candidate
directions include Claim integration, additional historical endings, stronger information-set Search
...
| Claims | ISkO | 4.4.4-4.4.6; bounded 4.1.3-4.1.6 | `partially_supported` | Flat positions support both 4.4.4 declarer-exposure branches, bounded exact final 4.4.5 defender open play, non-adjudicating 4.4.5/4.1.6 continuation, and final 4.4.6 open-card throw for either party. Historical games support all five terminal shortenings, timed non-terminal continuation for either public-hand branch, and the bounded sequence of at most one continuation before one terminal shortening. Existing terminal adjudicators remain authoritative. Matrix version `2` preserves those cases. Issue #183 adds private version-1 structured party-wide all-remaining-Tricks Claim, complete Evidence, exact-state, Proof Request/preparation, assignment, diagnostic-line, and Result contracts. Issue #184 adds deterministic bounded exhaustive exact AND/OR execution with claiming-party existential and opposing-party universal choices, canonical legal Cards and exact transitions, invocation-local memoization, exact counters, stable Representative Lines, and existing valid/invalid Result construction. Issue #185 adds private immutable adjudication Facts and Result, accepts only valid proof for exact point and Trick assignment, preserves a preexisting winner, applies Suit/Grand/Null level semantics, and composes through existing Final Settlement; invalid or unavailable proof creates no outcome. | Existing Runtime paths require concrete parties, final declaration/value, complete applicable public current or thrown hand or exact three-hand adjudication evidence, reliable ownership, hand size, current Trick, turn, and Skat reconciliation. The private Claim contracts and executor require one exact claimant Player and party, the complete Deal, exact legal play prefix and current Trick, complete remaining hands, Retrospective-only complete-world evidence, and an available reconciled preparation with one through five unresolved Tricks. Private adjudication additionally requires the exact Claim proof, assignment and settlement facts, with any preexisting winner reconciled. | The approved Claim has private adjudication and Final Settlement composition, but Runtime/Historical/Public integration remains absent. Specific future-Trick Claims, generalized non-jack exclusion, generalized correction, free text, natural language, simultaneous throws, arbitrary streams, unlimited proof, generative adjudication, unclassified conduct, multiple non-terminal events, and defender proof beyond five unresolved Tricks are `not_supported_v1`. | Retain existing Runtime behavior and test private metadata, unavailable passthrough and no-outcome behavior, one Request reconciliation, no replay/state rebuild, party quantifiers including both Defenders, current incomplete Tricks, all contract variants, one-through-five bounds, opposing-Trick baseline and terminal order, canonical exact transitions, memoization/counters, deterministic short-circuiting, stable full/decisive lines, exact point/Trick assignment, preexisting-winner preservation, Suit/Grand/Null levels, Final Settlement composition, no budget/timeout/randomness/Search, unchanged defender proof, Matrix/Runtime/public/privacy boundaries, and compatibility counts. | v1.0 bounded approved Claim private adjudication complete; Runtime/Historical/Public integration remains open | Yes |
...
| Final settlement | ISkO | 2.5.1-2.5.11; 3.6.1-3.6.4; bounded 4.1.3-4.1.6 | `partially_supported` | `final_settlement.py` covers existing paths plus historical/flat declarer-concession and accepted-exposure parity, exact defender-open-play assignment, open-card-throw opposing-party assignment, all Null variants, mandatory levels, supported overbid requirements, achieved levels, and settlement basis separation. A historical continuation before shortening delegates settlement unchanged to the selected terminal case. Issues #183 and #184 change no Settlement Runtime. Issue #185 privately composes valid-proof-only party-wide Claim adjudication through the existing Final Settlement while preserving a preexisting winner and applying Suit/Grand/Null level semantics; it adds no Runtime integration. | Complete or adjudicated result, valid declaration, game value, bid, and reliable Trick ownership, exact Historical prefix, bounded proof, or validated open-throw evidence where required. Private Claim composition additionally requires valid adjudication Facts with exact point and Trick assignment. | General Settlement remains explicitly partial. Issue #185 creates a private Claim outcome and Final Settlement only for valid proof; invalid or unavailable proof creates no outcome. Runtime/Historical/Public Claim integration remains absent. Unsupported endings and rule violations remain gaps. A continuation has no immediate Settlement. | Retain normative table coverage, shortening parity, assignment, continuation no-settlement, mandatory-versus-achieved-versus-rule-level, Null, overbid, theoretical-exclusion, unsafe-evidence, no-leakage, preexisting-winner preservation, Claim composition, and invalid/unavailable-proof no-outcome boundaries. | v1.0 | Yes |
...
Runtime behavior or any of its 61 case IDs. It keeps Claims, Concessions, and Final Settlement
`partially_supported`; distinguishes direct rules, approved bounded behavior,
legacy compatibility, one approved Runtime-unimplemented direction, and
durable v1 exclusions; and retains table-driven coverage for every current
...
adjudication Facts/Result, and Final Settlement composition exist. The Matrix
Runtime module tuple remains empty and its
`party_wide_claim_not_implemented` reason remains unchanged because Issue #185
adds no Runtime integration. Invalid or unavailable proof creates no terminal
outcome or Settlement. Every other current Claim boundary is
...
* ISkO 4.4.4-4.4.6 defines specific open-card shortcuts. It does not define a
  ...
  Runtime/Historical/Public integration remains absent.
