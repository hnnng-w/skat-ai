...
capabilities. Workspace, persistence, materialization, Public API, CLI, Schema,
example, generated scenario, and UI remain absent. `v1.0.0` remains unready
after this focused milestone work.
