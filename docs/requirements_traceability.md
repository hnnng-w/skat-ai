...
process-local artifacts for nine current authenticated downloads. See [Learning
...
game Counts without changing Dataset version `2`. Tactical quality assessment
...
derived fixed Policies without World weighting. Tactical quality assessment,
cross-game Coaching, Historical Teacher import, and broader solver work remain open. Issue
#193 adds
...
open. Issue #194 adds deterministic Historical Tactical Motif Review and private
