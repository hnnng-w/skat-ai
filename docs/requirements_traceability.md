...
Coaching, and selected Position/Historical Result propagation. Dataset, list,
general Opponent, complete non-legacy Result, and public provenance integration
remain open.
...
| Field-level information provenance | skat-ai product | Not applicable | `partially_supported` | Internal contract version `1` defines canonical RFC 6901 paths, immutable ledgers, coverage, dependencies, Information Use Context, redaction, serialization, and Confidence separation. Application and live-analysis provenance version `1` add complete flat and simulated live decision ledgers plus an all-leaf partial-legacy Position Result ledger. Retrospective-review and Replay Coaching provenance version `1` separate flat and Historical decision-time input/analysis from actual-card assessment, cover requested review and complete Coaching summaries, and add selected partial-legacy Position/Historical Result entries. | A live or retrospective Position or Historical Application invocation, its exact retained local/public decision stages and serialized Result, and matching internal sidecars. | Dataset, Dataset Preparation, list, general Opponent, complete non-legacy Result, and public provenance integration remain absent. Settlement, rating, list, terminal, and other Result branches retain explicit legacy exemptions. | Retain core contract tests plus complete live/retrospective decision coverage, all Search statuses and auto routing, Ouvert and continuations, profile dependencies, stage/context denial, actual/future/outcome isolation, private-root invariance, redaction, deterministic ordering, unchanged call counts, no public exports, unchanged schemas/CLI, and 70 generated outputs. | v0.13.0 live and retrospective propagation implemented; broader propagation remains open | Yes |
