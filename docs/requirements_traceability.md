...
change. Six blockers B-02 through B-07 remain; `v1.0.0` is not ready, and Issue
#202 is the next action.
...
before v1.0` cell contains `Yes`. After Issue #201, the authoritative ledger
contains 53 rows: 14 `satisfied`, 34
`satisfied_with_approved_bounded_scope`, 1 `evidence_required`, 3
