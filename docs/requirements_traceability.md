...
Issue #210 implements the shell and partially remediates UAT-FINDING-001 without
closing it. UAT-02 through UAT-12 are paused; Issue #211 is next; B-09 and B-07 remain open.
...
continue to describe implemented Package `0.17.0` behavior. Issue #210 adds the
[application shell](unified_local_frontend_application_shell.md) outside the
ledger; Issues #211 through #213 own the remaining frontend and CLI work.
